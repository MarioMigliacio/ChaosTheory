...
/// @brief Key to the LaserBeamProjectileSpriteKey Sprite Asset.
static auto LaserBeamProjectileSpriteKey = "LaserBeamProjectile";
...
static const std::unordered_map<std::string, std::string> Sprites = {
    ...
    {"LaserBeamProjectile", "assets/sprites/projectiles/LaserBeamProjectile.png"},
